...
class PositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position" do
    assert_difference('Position.count') do
      post positions_url, params: { position: { department_id: @position.department_id, title: @position.title } }
    end
  ...
  test "should update position" do
    patch position_url(@position), params: { position: { department_id: @position.department_id, title: @position.title } }
